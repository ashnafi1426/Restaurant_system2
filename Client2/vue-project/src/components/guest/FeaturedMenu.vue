...
const placeholderImage = 'https://images.unsplash.com/photo-1544025162-d76694265947?w=800'
</script>
  ...
  <section v-if="items.length" class="mb-10">
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <p class="text-slate-500 mt-1">Signature dishes carefully prepared by our chefs.</p>
      </div>
    </div>
