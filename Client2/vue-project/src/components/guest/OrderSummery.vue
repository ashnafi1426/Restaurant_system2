    ...
    <div class="px-6 py-5 border-b border-slate-200 bg-slate-50">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-sm text-slate-500">Review your order charges</p>
        </div>
      </div>
    </div>
    ...
    <div class="p-6 space-y-5">
      ...
      <div class="border-t border-slate-300 pt-5">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-xs text-slate-400 mt-1">Including VAT & Service Charge</p>
          </div>
      ...
      <div class="rounded-2xl bg-blue-50 border border-blue-200 p-5">
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1">
            <h3 class="font-bold text-slate-900">Payment Information</h3>

            <p class="mt-2 text-sm text-slate-600 leading-6">
              Your food order can be charged directly to your room account or paid at the reception,
        ...
        <div class="flex items-start gap-4">
          ...
          <div>
            ...
            <ul class="mt-3 space-y-2 text-sm text-slate-600">
              <li>• Orders are prepared immediately after confirmation.</li>

              <li>• Estimated delivery time is approximately 20–30 minutes.</li>

              <li>• Please keep your room phone available in case staff need to contact you.</li>

              <li>• Contact Reception if you wish to cancel or modify your order.</li>
            </ul>
          </div>
        </div>
      </div>
