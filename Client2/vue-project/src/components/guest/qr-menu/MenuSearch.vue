<template>
  <div class="luxury-search-container">
    ...
    <div class="relative">
      ...
      <div
        class="relative bg-white rounded-3xl shadow-2xl border-2 border-gray-100 hover:border-amber-200 focus-within:border-amber-400 transition-all duration-300 overflow-hidden"
      >
        <!-- Gold Search Icon -->
        <svg
      ...
      <Transition name="scale-fade">
        ...
        >
          ...
          <div
            ...
            class="border-b border-gray-100 py-4 px-6"
          >
            <p
              class="text-xs font-bold text-gray-600 uppercase tracking-widest mb-4 flex items-center gap-2"
            >
              <svg
          ...
          <div v-if="suggestions.length > 0" class="py-4">
            <p
              v-if="searchQuery"
              class="text-xs font-bold text-gray-600 uppercase tracking-widest px-6 pb-3 flex items-center gap-2"
            >
              <svg
                class="w-4 h-4 text-amber-500"
                fill="none"
            ...
            <div class="max-h-96 overflow-y-auto space-y-1 px-3">
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  <p
                    class="font-semibold text-gray-900 group-hover:text-amber-700 transition-colors truncate"
                  >
                    {{ suggestion.name }}
                  </p>
                  <p class="text-xs text-gray-600 group-hover:text-gray-700 mt-1">
                    {{ suggestion.category }}
                  </p>
                ...
                <!-- Arrow Icon -->
                <svg
                  class="w-5 h-5 text-gray-400 group-hover:text-amber-500 group-hover:translate-x-1 transition-all duration-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <div v-if="searchQuery && suggestions.length === 0" class="px-6 py-12 text-center">
            ...
            <p class="text-gray-500 text-sm mt-2">
              Try searching for: pizzas, salads, coffee, or drinks
            </p>
          </div>
          ...
          <div
            ...
            class="bg-gradient-to-r from-amber-50 to-transparent border-t border-amber-100 px-6 py-4"
          >
            <p
              class="text-xs text-amber-700 text-center font-medium flex items-center justify-center gap-1"
            >
