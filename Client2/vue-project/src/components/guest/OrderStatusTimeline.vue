  ...
  <div class="rounded-3xl bg-white shadow-lg border border-slate-200 overflow-hidden">
    ...
    <div class="px-6 py-5 border-b border-slate-200 bg-slate-50">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="mt-1 text-sm text-slate-500">Track your room service order</p>
        </div>

        <span class="px-4 py-2 rounded-full text-white text-sm font-semibold" :class="statusColor">
          {{ status.toUpperCase() }}
        </span>
      </div>
    </div>
    ...
    <div class="px-6 py-5 border-b border-slate-200 bg-white">
      <div class="grid grid-cols-2 gap-4">
        <div>
          <p class="text-xs uppercase text-slate-500">Order Number</p>

          <p class="font-bold text-slate-900 mt-1">#{{ orderNumber }}</p>
        </div>

        <div class="text-right">
          <p class="text-xs uppercase text-slate-500">Estimated Time</p>

          <p class="font-bold text-teal-600 mt-1">{{ estimatedMinutes }} Minutes</p>
        </div>
      </div>
    </div>
    ...
    <div class="border-t border-slate-200 bg-teal-50 px-6 py-5">
      <div class="flex items-center gap-4">
        ...
        <div class="flex-1">
          <h3 class="font-bold text-slate-900">Estimated Delivery</h3>
      ...
      <div class="flex items-start gap-4">
        ...
        <div>
          ...
          <p class="mt-2 text-sm leading-6 text-slate-600">
            If you need to modify or cancel your order, please contact the hotel reception
            immediately. Once the kitchen has started preparing the meal, changes may no longer be
            possible.
          </p>
        </div>
      </div>
