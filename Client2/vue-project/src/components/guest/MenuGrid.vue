    ...
    <div v-if="loading" class="grid gap-6 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
      ...
      >
        ...
        <div class="p-5 space-y-4">
          <div class="h-6 rounded bg-slate-200 animate-pulse" />

          <div class="h-4 rounded bg-slate-200 animate-pulse" />

          <div class="h-4 w-2/3 rounded bg-slate-200 animate-pulse" />

          <div class="flex justify-between pt-3">
            <div class="h-8 w-24 rounded bg-slate-200 animate-pulse" />

            <div class="h-10 w-28 rounded bg-slate-200 animate-pulse" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div v-else-if="items.length === 0" class="py-20">
      <div class="max-w-md mx-auto text-center">
        ...
        <p class="mt-3 text-slate-500">
          We couldn't find any dishes matching your search. Please choose another category or search
          again.
        </p>
      </div>
    </div>
